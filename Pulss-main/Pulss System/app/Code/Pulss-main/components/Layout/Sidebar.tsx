      ...
      <div className="p-3 border-b border-gray-100 flex flex-col gap-1">
        <button
          ...
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'sales' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <Briefcase className={`w-5 h-5 ${currentView === 'sales' ? 'text-brand-500' : 'text-slate-400'}`} />
          営業リード
        </button>
        <button
        ...
        <button
          onClick={() => onChangeView('hearings')}
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'hearings' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <MessageSquare className={`w-5 h-5 ${currentView === 'hearings' ? 'text-brand-500' : 'text-slate-400'}`} />
          ヒアリング/宿題
        </button>
        <button
          onClick={() => onChangeView('proposals')}
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'proposals' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <Newspaper className={`w-5 h-5 ${currentView === 'proposals' ? 'text-brand-500' : 'text-slate-400'}`} />
          提案/フォロー
        </button>
        <button
          onClick={() => onChangeView('contracts')}
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'contracts' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <Users className={`w-5 h-5 ${currentView === 'contracts' ? 'text-brand-500' : 'text-slate-400'}`} />
          契約/引き継ぎ
        </button>
        <button
        ...
        <button
          ...
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'tasks' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <Calendar className={`w-5 h-5 ${currentView === 'tasks' ? 'text-brand-500' : 'text-slate-400'}`} />
          タスク/テンプレ
        </button>
        <button
        ...
        <button
          ...
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'calendar' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <Calendar className={`w-5 h-5 ${currentView === 'calendar' ? 'text-brand-500' : 'text-slate-400'}`} />
          投稿カレンダー
        </button>
        <button
          onClick={() => onChangeView('reports')}
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'reports' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <Newspaper className={`w-5 h-5 ${currentView === 'reports' ? 'text-brand-500' : 'text-slate-400'}`} />
          効果レポート
        </button>
        <button
          onClick={() => onChangeView('notifications')}
          className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
            currentView === 'notifications' ? 'bg-brand-50 text-brand-700' : 'text-slate-600 hover:bg-gray-50'
          }`}
        >
          <AlertTriangle className={`w-5 h-5 ${currentView === 'notifications' ? 'text-brand-500' : 'text-slate-400'}`} />
          通知センター
        </button>
      </div>
